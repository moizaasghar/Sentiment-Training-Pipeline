...
testing = os.environ.get("TESTING").lower()  # Check if testing mode is enabled
...
model_arf = wandb.Artifact(name="sentiment-model", type="model")
model_arf.add_dir("bert-tiny-imdb")
run.log_artifact(model_arf)
...
data_arf = wandb.Artifact(name="sentiment-data", type="dataset")
data_arf.add_file("train_split.csv")
